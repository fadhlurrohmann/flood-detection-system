...
Then set EFWS_API_URL=http://<ip-komputer-this>:5000/api/v1/efws in .env
"""
import json
...
if __name__ == "__main__":
    ...
    print(f"Mock API server running in http://{HOST}:{PORT}")
    print("Press Ctrl+C for stop. Waiting request...\n")
    try:
