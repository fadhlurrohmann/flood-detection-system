...
CATATAN PENTING soal kompatibilitas AT command:
  ...
  SIM7600 for fungsi modem dasar (AT, AT+CSQ, AT+CREG?, AT+CGDCONT,
...
class SIM7600:
    """
    Nama class dipertahankan 'SIM7600' for kompatibilitas import di
    main.py - tapi command internal sudah disesuaikan for A7670E/SIM7670E.
    """
    ...
    def _parse_cgpsinfo(self, raw: str) -> dict | None:
        """
        Parse respons AT+CGPSINFO (format sama for SIM7600 & A7670E/SIM7670E).
